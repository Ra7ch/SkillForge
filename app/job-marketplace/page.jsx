...
import { Search, Filter, MapPin, DollarSign, Calendar, ChevronDown, ChevronUp, CheckCircle } from "lucide-react"
...
export default function JobMarketplace() {
  ...
  const handleApplyToJob = (applicationData) => {
    ...
    // Reset application after a short delay
    setTimeout(() => {
  ...
  return (
    <ToastProvider>
      <div className="container mx-auto py-8">
                ...
                sortedJobs.map((job) => (
                  <Card 
                    ...
                    className={`cursor-pointer transition-colors hover:bg-gray-50 ${
                      expandedJobId === job.id ? 'border-orange-500' : ''
                    }`}
                  ...
                  >
                    <CardContent className="p-4 md:p-6">
                      <div className="space-y-4">
                        ...
                        <p className={`text-gray-700 text-sm ${expandedJobId === job.id ? '' : 'line-clamp-2'}`}>
                          {job.description}
                        </p>
                        ...
                        <div className="flex flex-wrap gap-1">
                          ...
                          {job.skills.length > 4 && expandedJobId !== job.id && (
                            <Badge variant="secondary" className="font-normal">
                              +{job.skills.length - 4} more
                            </Badge>
                          )}
                          {expandedJobId === job.id && job.skills.length > 4 && 
                            job.skills.slice(4).map((skill, index) => (
                              <Badge key={`extra-${index}`} variant="secondary" className="font-normal">
                                {skill}
                              </Badge>
                            ))
                          }
                        ...
                        {expandedJobId === job.id && (
                          <div className="mt-4 pt-4 border-t border-gray-200">
                            <div className="space-y-4">
                              <div>
                                <h3 className="font-medium mb-2">About this job</h3>
                              ...
                              <div>
                                <h3 className="font-medium mb-2">About the client</h3>
                                <div className="text-sm space-y-1 text-gray-700">
                                  ...
                                  <p className="flex items-center">
                                    ...
                                    <span className="flex items-center">
                                      ...
                                      <span className="text-gray-500 ml-1">({job.client.reviews} reviews)</span>
                                    </span>
                                  </p>
                                  {job.client.verified && (
                                    <p className="flex items-center">
                                ...
                                <Button 
                                  onClick={(e) => {
                                    ...
                                    handleApplyToJob({
                                      jobId: job.id,
                                      coverLetter: "",
                                      bidAmount: job.budget.amount,
                                      bidType: job.budget.type
                                    });
                                  }}
        ...
        {showToast && (
          <div className="fixed bottom-4 right-4 bg-green-100 border border-green-200 text-green-800 rounded-lg p-4 shadow-lg animate-in fade-in slide-in-from-bottom-5 duration-300 max-w-md">
            <div className="flex items-start gap-3">
              <div className="h-6 w-6 text-green-500 mt-0.5">
                <CheckCircle className="h-6 w-6" />
              </div>
              <div>
                <h3 className="font-medium">Application Submitted!</h3>
                <p className="text-sm text-green-700">Your job application has been sent successfully. You'll be notified when the client responds.</p>
              </div>
            </div>
          </div>
        )}
